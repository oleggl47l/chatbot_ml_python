...
class CasualDialogHandler:
    ...
    def get_response(self, text: str) -> tuple[None, bool] | tuple[str | Any, bool]:
        """
        Возвращает ответ и флаг, нужно ли добавлять рекламное предложение
        Returns: (response, should_add_ad)
        """
